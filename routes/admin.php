...
Route::group(['middleware' => 'admin.auth.admin:admin'], function(){
    ...
    Route::prefix('/manager-employee')->as('employee.')->group(function(){
        Route::controller(App\Admin\Http\Controllers\Employee\EmployeeController::class)
            ->group(function(){
    ...
    Route::prefix('/blog2')
        ...
        ->group(function() {
            //Post category
            Route::prefix('/categories')->as('category.')->group(function(){
                Route::controller(App\Admin\Http\Controllers\Blog2\Category\CategoryController::class)->group(function(){
                    Route::get('/add', 'create')->name('create');
                    Route::get('/', 'index')->name('index');
                    Route::get('/edit/{id}', 'edit')->name('edit');
                    Route::put('/edit', 'update')->name('update');
            ...
            //Post
            Route::prefix('/posts')->as('post.')->group(function(){
                Route::controller(App\Admin\Http\Controllers\Blog2\Post\PostController::class)->group(function(){
                    Route::get('/', 'index')->name('index');
                    Route::get('/add', 'create')->name('create');
                    Route::get('/edit/{id}', 'edit')->name('edit');
                    Route::put('/edit', 'update')->name('update');
