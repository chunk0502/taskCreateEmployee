...
class BlogController extends Controller
{
    ...
    {
        return [
            'post' => 'public.layouts.post',
            'detail' => 'public.layouts.detail',
            'cate' => 'public.layouts.posts.post-by-cate',
        ];
    }
    ...
    public function showPost($slug)
    {
        ...
        $related = $this->repoPost->getByLimit([
            ...
            'categories' => fn ($q) => $q->whereIn('id', $posts->categories->pluck('id')->toArray())], [], 5);
